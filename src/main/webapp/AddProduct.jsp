...
<head>
<meta charset="UTF-8">
<title>ShopHouse: add product</title>
...
<body>
    ...
    <div id="main_content">
        <div id="form">
            <form id="form_box" action="AddProduct" method="post" enctype="multipart/form-data">
                <div id="heading">
                    <h1>Add Product</h1>
                </div>
                <div id="id_div" class="inputs">
                    <label for="id">ID : </label><input type="number" name="id" id="id" class="input_box">
                </div>
                <div id="name_div" class="inputs">
                    <label for="name">name : </label><input type="text" name="name" id="name" class="input_box">
                </div>
                <div id="brand_div" class="inputs">
                    <label for="brand">Brand : </label><input type="text" name="brand" id="brand" class="input_box">
                </div>
                <div id="price_div" class="inputs">
                    <label for="price">Price : </label><input type="number" name="price" id="price" class="input_box"> 
                </div>
                <div id="discount_div" class="inputs">
                    <label for="discount">Discount : </label><input type="number" name="discount" id="discount" class="input_box">
                </div>
